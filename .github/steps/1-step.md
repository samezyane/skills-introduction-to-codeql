...
<img width="250" align="right" alt="codeql default configuration box" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/codeql-default-configuration-box.png?raw=true"/>
...
1. In the **CodeQL** setting, click the **Set up** dropdown menu and choose **Default**.
   ...
   <img width="400" alt="enable code scanning" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/enable-code-scanning.png?raw=true"/>
