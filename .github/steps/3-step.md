...
<img width="600" alt="image" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/security-tab-overview.png?raw=true" />
...
<img width="600" alt="additional information" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/additional-information.png?raw=true"/>
...
1. Return to the recently created pull request. Ignore the failed check and click the **Merge pull request** button.
   ...
   <img width="300" alt="merge button" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/merge-button.png?raw=true" />
...
1. In the left navigation, notice that the **Code Scanning** option now has a `1` entry next to it, informing us of an open alert.
   ...
   <img width="250" alt="code scanning alerts count" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/code-scanning-alerts-count.png?raw=true" />
...
1. Notice the description, vulnerability description, and a recommended solution.
   ...
   <img width="600" alt="alert overview" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/alert-overview.png?raw=true" />
...
1. Select the `Used in tests` option and enter the below description.
   ...
   <img width="300" alt="dismiss alert options" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/dismiss-alert-options.png?raw=true" />
...
1. Click the **Dismiss alert** button.
   ...
   <img width="300" alt="audit log entry showing alert dismissed" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/audit-log-alert-dismissed.png?raw=true" />
