...
1. Click on **Closed** to show our recently resolved alert.
   ...
   <img width="350" alt="image" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/closed-alerts-button.png?raw=true" />

1. Open our alert and notice the audit trail now includes how the alert was fixed.

   <img width="350" alt="image" src="https://github.com/samezyane/skills-introduction-to-codeql/blob/main/.github/images/audit-trail-fixed-alert.png?raw=true" />
